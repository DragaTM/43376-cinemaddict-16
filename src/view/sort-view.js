...
const createSortTemplate = () => (
  `<ul class="sort">
    ...
    <li><a href="#" class="sort__button" data-sort-view="${SortType.DATE}">Sort by date</a></li>
    <li><a href="#" class="sort__button" data-sort-view="${SortType.RATING}">Sort by rating</a></li>
  </ul>`
);
